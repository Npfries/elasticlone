/*
  ...
  - Added the required column `type` to the `Migration` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Migration" ("data", "hostId", "id", "name") SELECT "data", "hostId", "id", "name" FROM "Migration";
